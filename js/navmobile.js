const OPEN_NAV_MOBILE = document.getElementById("nav-mobile__btn--open"); // Przycisk otwierania
const NAV_MOBILE_CONTAINER = document.getElementById("nav-mobile--opened"); // Otwarta nawigacja mobilna
const CLOSE_NAV_MOBILE = document.getElementById("nav-mobile__btn--close"); // Przycisk zamykania
